...
public class Ejecutor2 {
    ...
    public static void main(String[] args) {
        ...
        estDistancia.establecerApellidoEstudiante("Carlos Salas");        
        String cadenaFina2 = String.format("%s", estDistancia);
        cadenaFina2 = String.format("%s\n"
                + "Costo Asignatura: %.2f\n"
                + "Número de Asignaturas: %d\n"
                + "Total Matricula: %.2f\n",
                cadenaFina2,
                ...
                estDistancia.obtenerNumeroAsignaturas(),
                estDistancia.obtenerMatriculaDistancia());
        System.out.println(cadenaFina2);
